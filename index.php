...
";
    ...
    $form.="</select>
        ...
        <span class=\"divider-vertical\"></span>
<!--
		<a target=\"_blank\" href=\"index.php?upload\" class=\"btn btn-default active\" role=\"button\">Upload</a>
        <a                   href=\"index.php?update\" class=\"btn btn-default active\" role=\"button\">Update</a>
        <a target=\"_blank\" href=\"index.php?cmd=sh\" class=\"btn btn-default active\" role=\"button\">Shell</a>
-->
    </div>
</form>\n";
...
$(document).ready(function(){
	...
	function save(run)
	{
		...
		if (editfile=='' || editfile.substr(0,1) == '_') editfile=prompt("Enter filename");
		if (editfile.substr(editfile.length-4) != '.php') editfile+='.php';
		$('#editfile').val(editfile);
		editor.save();
        ...
        $.ajax({
            ...
            success: function(data){
				...
				if (run)
				{
					...
					window.location.href='index.php?file='+editfile;
            },
            error: function(xhr){
